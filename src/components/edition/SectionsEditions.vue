...
const editions = ref([
    {
        ...
        description: "Voce pode aprender muito mais do que imagina, participe do hackaton e veja o que pode aprender",
        route: '/',
...
button::before {
    ...
    border-radius: 50px;
    padding: 1.5px;
    background: linear-gradient(114.55deg, rgba(255, 255, 255, 0.9) 2.13%, rgba(255, 255, 255, 0) 98.14%);
