...
import detailEdition from "@/services/detailEdition";
...
<template>
    <section>
        <div class="container">
            ...
            <div class="editions">
                <CardWinnerTeam v-for="(object, index) in useDetailEdition.allTeams" :key="index" :object="object"
